...
public class ConnectToMongoDB {
    ...
    public void newInsertIntoMongoDB(List<HelpClass> newsList, String cnnApi) {
    }

    public List<HelpClass> ReadListFromMongoDB1(List<HelpClass> newsList, String cnnApi) {
